...
namespace khronos { namespace utils {
...
public:
    ...
    static inline ConstPointer createFile(const std::string& filename, const std::vector<T>& data) {
...
public:
    static inline void setAssetManager(AAssetManager* assetManager) {
